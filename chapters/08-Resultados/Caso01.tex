...
\end{adjustbox}
\end{listing}
\paragraph{Salida} Mensaje confirmando la generación de la trayectoria, seguido de la forma del tensor y la última fila (placeholder numérico).
...
\end{adjustbox}
\end{listing}
\paragraph{Salida} Logs describiendo energía total, distancias extremas, etc.~(placeholder textual).
...
\end{adjustbox}
\end{listing}
\paragraph{Salida} Figura generada (placeholder: \texttt{img/resultados/caso01\_lambda.png}).
...
\end{adjustbox}
\end{listing}
\paragraph{Salida} Figura de evolución del fitness (placeholder: \texttt{img/resultados/caso01\_fitness.png}).
...
\end{adjustbox}
\end{listing}
\paragraph{Salida} Figura mostrada in situ (placeholder: \texttt{img/resultados/caso01\_planar.png}).
...
\end{adjustbox}
\end{listing}
\paragraph{Salida} Animación en memoria y figura con la distancia (placeholders de imágenes: \texttt{img/resultados/caso01\_masas.png}).
...
\end{adjustbox}
\end{listing}
\paragraph{Salida} Texto indicando el CSV usado, tabla con las primeras filas y tabla de estadísticas (placeholder: \texttt{img/resultados/caso01\_timings.png}).
...
\end{adjustbox}
\end{listing}
\paragraph{Salida} Mensajes del comando ejecutado y cuatro imágenes generadas (placeholders: \texttt{img/resultados/timeline\_*.png}).
