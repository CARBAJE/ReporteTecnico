...
\end{adjustbox}
\end{listing}
\paragraph{Salida esperada} Logs con energía total, periodos estimados, etc.
...
\end{adjustbox}
\end{listing}
\paragraph{Salida esperada} Objeto \texttt{anim} en memoria.
...
\end{adjustbox}
\end{listing}
\paragraph{Salida esperada} Animación/figura comparativa.
...
\end{adjustbox}
\end{listing}
\paragraph{Salida esperada} Texto con el CSV usado y tablas renderizadas.
...
\end{adjustbox}
\end{listing}
\paragraph{Salida esperada} Cuatro imágenes.
